...
BEGIN_MESSAGE_MAP(CCCtlDlg, CDialog)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_CBN_CLOSEUP(IDC_COMBO_DROPDOWN, &CCCtlDlg::OnCloseupComboDropdown)
	ON_CBN_CLOSEUP(IDC_COMBO_DROPLIST, &CCCtlDlg::OnCloseupComboDroplist)
	ON_CBN_SELCHANGE(IDC_COMBO_SIMPLE, &CCCtlDlg::OnSelchangeComboSimple)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
